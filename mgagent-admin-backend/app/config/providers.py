...
PROVIDERS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": "智谱 AI 大模型服务平台（含重排模型）",
    },
    {
        "code": "minimax",
    ...
    },
    {
        "code": "cohere",
        "display_name": "Cohere",
        "favicon_domain": "api.cohere.com",
        "default_api_base": "https://api.cohere.com/v1",
        "supports_api_key": True,
        "supports_local": False,
        "supports_discover": True,
        "supported_model_types": ["reranker", "embedding"],
        "fallback_models": {
            "reranker": ["rerank-v3.5"],
            "embedding": ["embed-v4.0"],
        },
        "description": "全球领先的重排模型厂商，rerank-v3.5 英文最强",
    },
    {
        "code": "siliconflow",
        "display_name": "硅基流动",
        "favicon_domain": "api.siliconflow.cn",
        ...
        "description": "国内 OpenRouter，聚合开源模型 API，含 bge-reranker-v2-m3",
    },
    {
        "code": "qianfan",
        "display_name": "百度千帆",
        "favicon_domain": "qianfan.baidubce.com",
        ...
        "supported_model_types": ["chat", "embedding", "reranker"],
        "fallback_models": {
            "chat": ["ERNIE-4.0-Turbo-8K", "ERNIE-3.5-8K"],
            "embedding": ["bge-large-zh"],
            "reranker": ["bce-reranker-base_v1"],
        },
        "description": "百度文心一言千帆平台，ERNIE + BCE 重排模型",
    },
    {
        "code": "local",
        "display_name": "本地模型 (私有化部署)",
        ...
        "description": "使用 HuggingFace sentence-transformers 本地运行 Embedding / CrossEncoder 重排（免 API Key）",
    },
    {
        "code": "custom",
